...
menuItem8 = MenuItem(user_id=1, name="Veggie Burger",
                     description=("Made with freshest of ingredients and "
                                  "home grown spices"),
...
menuItem2 = MenuItem(user_id=1, name="Peking Duck",
                     description=("A famous duck dish from Beijing[1] that "
                                  ...
                                  "The meat is prized for its thin, crisp "
                                  "skin, with authentic versions of the dish "
...
menuItem3 = MenuItem(user_id=1, name="Gyoza",
                     description=("light seasoning of Japanese gyoza with salt"
                                  " and soy sauce, and in a thin gyoza "
                                  "wrapper"),
...
menuItem2 = MenuItem(user_id=1, name="Veggie Burger",
                     description=("Juicy grilled veggie patty with tomato ma"
                                  "yo and lettuce"),
...
menuItem1 = MenuItem(user_id=1, name="Tres Leches Cake",
                     description=("Rich, luscious sponge cake soaked in swee"
                                  "t milk and topped with vanilla bean whipped"
...
menuItem3 = MenuItem(user_id=1, name="Honey Boba Shaved Snow",
                     description=("Milk snow layered with honey boba, jasmin"
                                  "e tea jelly, grass jelly, caramel, cream, "
...
menuItem4 = MenuItem(user_id=1, name="Cauliflower Manchurian",
                     description=("Golden fried cauliflower florets in a mid"
                                  "ly spiced soya,garlic sauce cooked with fr"
                                  "esh cilantro, celery, chilies,ginger & gre"
                                  "en onions"),
...
menuItem1 = MenuItem(user_id=1, name="Shellfish Tower",
                     description=("Lobster, shrimp, sea snails, crawfish, st"
                                  "acked into a delicious tower"),
...
menuItem3 = MenuItem(user_id=1, name="Mom's Spaghetti",
                     description=("Spaghetti with some incredible tomato sau"
                                  "ce made by mom"),
...
menuItem4 = MenuItem(user_id=1,
                     name=("Choc Full O\' Mint (Smitten\'s Fresh "
                           "Mint Chip ice cream)"),
                     description=("Milk, cream, salt, ..., Liquid nitrogen m"
                                  "agic"),
...
menuItem5 = MenuItem(user_id=1, name="Tonkatsu Ramen",
                     description=("Noodles in a delicious pork-based broth w"
                                  "ith a soft-boiled egg"),
                     price="$7.95", course="Entree", restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1, name="Lamb Curry",
                     description=("Slow cook that thang in a pool of tomatoe"
                                  "s, onions and alllll those tasty Indian "
                                  "spices. Mmmm."),
                     price="$9.95", course="Entree", restaurant=restaurant1)
...
menuItem3 = MenuItem(user_id=1, name="Potstickers",
                     description=("Delicious chicken and veggies encapsulate"
                                  "d in fried dough."),
...
menuItem9 = MenuItem(user_id=1, name="Chicken Fried Steak",
                     description=("Fresh battered sirloin steak fried and sm"
                                  "othered with cream gravy"),
                     price="$8.99", course="Entree", restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1, name="Boysenberry Sorbet",
                     description=("An unsettlingly huge amount of ripe berri"
                                  "es turned into frozen (and seedless) "
                                  "awesomeness"),
                     price="$2.99", course="Dessert", restaurant=restaurant1)
...
menuItem2 = MenuItem(user_id=1, name="Cachapa",
                     description=("Golden brown, corn-based Venezuelan panca"
                                  "ke; usually stuffed with queso telita or "
...
menuItem1 = MenuItem(user_id=1, name="Guanciale Chawanmushi",
                     description=("Japanese egg custard served hot with spic"
                                  "ey Italian Pork Jowl (guanciale)"),
...
menuItem1 = MenuItem(user_id=1, name="Lemon Curd Ice Cream Sandwich",
                     description=("Lemon Curd Ice Cream Sandwich on a chocol"
                                  "ate macaron with cardamom meringue and "
                                  "cashews"),
